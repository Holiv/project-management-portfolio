...
<meta name="description" content="Engenheiro civil com foco em planejamento e controle que constrói as ferramentas usadas para acompanhar obras — cinco criações em uso real, documentadas do problema ao resultado.">
...
.numeros .grid{{display:grid;grid-template-columns:repeat(auto-fit,minmax(215px,1fr));gap:12px;margin-top:16px}}
.numeros .n{{display:block;background:var(--card);border:1px solid var(--rule);border-left:3px solid var(--accent);border-radius:8px;padding:14px 15px;text-decoration:none;color:inherit;transition:border-color .12s,transform .12s}}
.numeros a.n:hover{{border-color:var(--accent);transform:translateY(-1px)}}
.numeros .n strong{{display:block;font:600 22px/1.2 "Fraunces",Georgia,serif;color:var(--accent-ink);letter-spacing:-.01em}}
.numeros .n span{{display:block;font-size:13.5px;color:var(--mute);margin-top:5px}}
.numeros a.n span.ver{{color:var(--accent-ink);font-weight:600;font-size:12.5px;margin-top:7px}}
.numeros .ress{{font-size:13px;color:var(--mute);margin-top:14px}}
.numeros .extra{{font-size:13.5px;color:var(--mute);margin-top:10px;padding-top:10px;border-top:1px solid var(--rule)}}
ul.idx{{list-style:none;margin:16px 0 0;padding:0}}
ul.idx li{{padding:9px 0;border-bottom:1px solid var(--rule);font-size:15px}}
ul.idx a{{font-weight:600;text-decoration:none}}
ul.idx a:hover{{text-decoration:underline}}
ul.idx span{{color:var(--mute)}}
...
<p class="lede">Engenheiro civil (CREA-RJ), <strong>planejamento e controle</strong>. Construo as ferramentas que a empresa inteira usa para acompanhar suas obras — de quem lança o dado em campo a quem decide na gestão. <strong>Cinco criações em uso real</strong> no programa de concessão da Arteris na BR-101/RJ, documentadas do problema ao resultado.</p>
...
<a href="#numeros">Resultados</a><a href="#onde-operam">O programa</a><a href="#ecossistema">Ecossistema</a><a href="#comparador">Comparador</a><a href="#analise">Análise crítica</a><a href="#equipe">Equipe</a><a href="#linha-do-tempo">Linha do tempo</a><a href="#capacidades">Capacidades</a>
</div></nav>
<main class="wrap">
<section id="numeros" class="numeros"><h2>Resultados</h2>
<p>O que estes sistemas produziram, com a formulação que cada número comporta — clique para ver como.</p>
<div class="grid">
<a class="n" href="#comparador"><strong>Reporte a acionistas</strong><span>relatórios adotados pela empresa para reporte interno, gerencial e a acionistas</span><span class="ver">ver o comparador →</span></a>
<a class="n" href="#analise"><strong>5.251 atividades em &lt; 30 s</strong><span>análise crítica completa de cronograma, contra ≈3 h no processo manual</span><span class="ver">ver a análise crítica →</span></a>
<a class="n" href="#comparador"><strong>Horas → &lt; 10 min</strong><span>ciclo de comparação entre revisões de cronograma</span><span class="ver">ver o comparador →</span></a>
<a class="n" href="#ecossistema"><strong>25 contas reais · 2 setores</strong><span>~6 semanas de operação, medido no banco de produção em 22/08/2026</span><span class="ver">ver o ecossistema →</span></a>
<a class="n" href="#cronoaudit"><strong>Aberta e verificável</strong><span>cronoaudit: Agent Skill pública, Apache 2.0 — qualquer pessoa pode abrir e conferir</span><span class="ver">ver a cronoaudit →</span></a>
</div>
<p class="ress">Cada número acima carrega data e método na seção correspondente. Onde a medida é estimativa do autor, está dito — o "≈3 h" do processo manual é estimativa de prática, não cronometragem, e o ciclo de comparação foi informado pelo autor, não instrumentado.</p>
<p class="extra">Outros números de operação: arquivos de até <strong>6.483 atividades (60 MB)</strong> processados com validação automática · <strong>seis janelas semanais consecutivas</strong> de comparação consumidas via API, sem interrupção · <strong>~193 mil registros</strong> de avanço físico no acervo · concepção, arquitetura, implementação e operação <strong>por uma pessoa</strong>.</p>
<h3 style="margin-top:26px">As cinco criações</h3>
<ul class="idx">
<li><a href="#ecossistema">Ecossistema de acompanhamento de obras</a> <span>— plataforma web de project controls, em produção</span></li>
<li><a href="#comparador">Comparador de cronogramas</a> <span>— motor VBA Excel ↔ MS Project, em uso semanal</span></li>
<li><a href="#analise">Análise crítica de cronogramas</a> <span>— auditoria executável dentro do MS Project</span></li>
<li><a href="#equipe">Gestão de equipe e competências</a> <span>— série longitudinal de dados, em uso pela equipe</span></li>
<li><a href="#cronoaudit">cronoaudit</a> <span>— Agent Skill pública, formato aberto, Apache 2.0</span></li>
</ul>
</section>
